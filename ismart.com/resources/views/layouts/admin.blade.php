...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/c1oyoraggnjae3yttkbi1c9p2j4ju5k1qvyyxxjhfn9rs9mq/tinymce/4/tinymce.min.js" referrerpolicy="origin"></script>
    <script type="text/javascript">
        var editor_config = {
            path_absolute: "http://localhost:81/ismart.com/",
            selector: ".textarea",
            height:250,
            plugins: [
            ...
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{$module_active == 'slider'?'active':''}}">
                        <a href="{{route('admin.slider.show')}}">
                            <div class="nav-link-icon d-inline-flex">
                                <i class="far fa-folder"></i>
                            </div>
                            Slider
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{route('admin.slider.show')}}">Danh sách</a></li>
                        </ul>
                    </li>
                    <li class="nav-link {{$module_active == 'post'?'active':''}}">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ route('admin.post.show') }}">Danh sách</a></li>
                            <li><a href="{{route('admin.catPost.add')}}">Danh mục</a></li>
                        </ul>
                    </li>
                    <li class="nav-link {{$module_active == 'product'?'active':''}}">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{route('admin.cat.add')}}">Danh mục</a></li>
                        </ul>
                    </li>
                    <li class="nav-link {{$module_active == 'sales'?'active':''}}">
