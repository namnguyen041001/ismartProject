    ...
    <div class="row">
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.cat.edit',$cat->id)}}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.cat.delete',$item->id)}}" onclick="return confirm('Thêm thùng rác!')" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            @empty
                            <tr>
