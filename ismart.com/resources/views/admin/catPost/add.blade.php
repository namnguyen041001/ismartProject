    ...
    <div class="row">
        <div class="col-4">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form action="{{route('admin.catPost.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted pb-2">(Không chọn để hiện thị trên thanh Menu)</small>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.catPost.delete',$item->id)}}" onclick="return confirm('Chú ý: cần xóa danh mục con trước khi xóa danh mục cha')" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            @empty
                            <tr>
